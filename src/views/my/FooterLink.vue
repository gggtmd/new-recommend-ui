...
<template>
  <div class="footer-link">
    <div class="about-wrapper">
      ...
      <div class="about-us">
        <p>
          本系统由xx大学xx学院xx、xx、xx三人合作开发，指导教师为xx大学xx学院xx教授和xx副教授。近年来xx教授曾主持国家自科基金面上项目、湖南省自科基金面上项目等科研课题近10项，以第一作者在TPDS、TSC、TLT等国际顶级和权威的SCI、SSCI期刊发表论文10余篇。主持和参与大型横向课题多项，获得国家发明专利授权7项。
        </p>
        <p>
          本系统获得了xx大学的国家“世界一流”建设学科“外国语言文学”的支持，该学科不懈推广中华文化的卓越成就，在培养具有国际视野的国际化人才、服务于国家的安全战略、外交政策、一带一路倡议以及地区经济和社会进步等方面具有独特优势。本项目也得到了“人工智能与精准国际传播”湖南省哲学社会科学重点实验室、xx大学xx研究院、xx学院的大力支持。
        </p>
      </div>
    </div>
  </div>
